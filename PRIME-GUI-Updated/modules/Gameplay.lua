...
function AddEspCorner(anchorX, anchorY)
    ...
    NexusUI:BindColor(hBar, "BackgroundColor3", function() return ACCENT end)
    ...
    NexusUI:BindColor(vBar, "BackgroundColor3", function() return ACCENT end)
...
function makePlayerInfoLabel(text, size, color, yPos, fontWeight)
    ...
    lbl.Text = text
    local role = color == COLOR_TEXT and 7 or color == COLOR_TEXT_DIM and 8
    NexusUI:BindColor(lbl, "TextColor3", function() return role and NexusUI.Palette[role] or color end)
