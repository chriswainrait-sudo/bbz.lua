...
Tabs.Main:AddToggle("AutoDribble", {
    ...
    Callback = function(Value)
        ...
        local animations = {
            ...
            ["rbxassetid://101683719313060"] = true,
        }
        local connections = {}
        ...
        local function activate(player, character, track)
            if not AutoDribbleEnabled or player.Team == LocalPlayer.Team then return end
            ...
            if not root or not enemyRoot or (root.Position - enemyRoot.Position).Magnitude > 35 then return end
            ...
            if activateGuiButton(ball and ball:FindFirstChild("Dribble")) then
                lastActivation = now
            end
        end
