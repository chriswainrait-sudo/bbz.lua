...
do
    ...
    local config = {
        ...
        AutoRebound = false, ReboundRange = 65,
    ...
    extras = (function()
        ...
        function api.update(dt)
            ...
            if not ready then
                ...
                state.rebounding = false; state.flightUntil = 0
                return
            end
