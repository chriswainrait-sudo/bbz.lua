...
COLOR_WINDOW = Color3.fromRGB(8, 8, 10)
COLOR_TOPBAR = Color3.fromRGB(4, 4, 6)
COLOR_GROUP = Color3.fromRGB(16, 16, 19)
COLOR_CONTROL = Color3.fromRGB(26, 26, 30)
COLOR_BORDER = Color3.fromRGB(62, 62, 68)
COLOR_TEXT = Color3.fromRGB(245, 245, 248)
COLOR_TEXT_DIM = Color3.fromRGB(150, 150, 158)
...
function CreateClickButton(parent, text, size, position, bgColor, textColor, font, textSize, disableHover)
    ...
    button.BackgroundColor3 = bgColor or COLOR_CONTROL
    ...
    local hoverBackground = defaultBackground:Lerp(Color3.fromRGB(255, 255, 255), 0.08)
    local pressedBackground = defaultBackground:Lerp(Color3.fromRGB(255, 255, 255), 0.18)
    local hovered = false
    local pressed = false
...
function NexusUI:CreateWindow(options)
    ...
    mainFrame.BackgroundColor3 = COLOR_WINDOW
    ...
    innerClip.BackgroundColor3 = COLOR_WINDOW
    ...
    local function animateWindowIn()
        ...
        if windowScale then
            windowScale.Scale = 0.75
            TweenService:Create(windowScale, TweenInfo.new(animationDuration, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Scale = 1}):Play()
        end
    ...
    local function animateWindowOut(callback)
        ...
        local windowScale = mainFrame:FindFirstChild("NexusWindowScale")
        if windowScale then
            TweenService:Create(windowScale, TweenInfo.new(animationDuration, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {Scale = 0.85}):Play()
        end
    ...
    topBarPatch.BackgroundColor3 = COLOR_TOPBAR
    ...
    topBarDivider.BackgroundColor3 = COLOR_BORDER
    ...
    logoGradient.Color = ColorSequence.new({
        ...
        ColorSequenceKeypoint.new(0.35, Color3.fromRGB(150, 150, 155)),
    ...
    logoSubtitle.TextColor3 = Color3.fromRGB(255, 255, 255)
    ...
    local tabStrip = Instance.new(IS_MOBILE and "ScrollingFrame" or "Frame")
    ...
    if IS_MOBILE then
        ...
        tabStrip.ScrollBarImageColor3 = COLOR_BORDER
        ...
        local function updateMobileTabStripBounds()
            ...
            local measuredLogoWidth = math.floor((logoContainer.AbsoluteSize.X or 0) + 0.5)
    ...
    tabStripLayout.HorizontalAlignment = IS_MOBILE and Enum.HorizontalAlignment.Left or Enum.HorizontalAlignment.Right
    ...
    if IS_MOBILE then
        ...
        tabSwipeHint.TextColor3 = COLOR_TEXT_DIM
    ...
    local function createRestoreGui()
        ...
        restoreFrame.BackgroundColor3 = COLOR_WINDOW
        ...
        restoreLabel.TextColor3 = ACCENT
        ...
        restoreStroke.Color = COLOR_BORDER
    ...
    local function createCloseConfirm()
        ...
        dialog.BackgroundColor3 = COLOR_WINDOW
        ...
        dialogStroke.Color = COLOR_BORDER
        ...
        dialogTop.BackgroundColor3 = COLOR_TOPBAR
        ...
        dialogTopPatch.BackgroundColor3 = COLOR_TOPBAR
        ...
        dialogText.TextColor3 = Color3.fromRGB(205, 205, 210)
        ...
        if closeConfirmLabel then
            ...
            closeConfirmLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
    ...
    local function createCornerButton(text, order)
        ...
        btn.BackgroundColor3 = COLOR_CONTROL
        ...
        TrackGuiConnection(btn.MouseEnter:Connect(function()
            TweenService:Create(btn, TweenInfo.new(0.1, Enum.EasingStyle.Quad), {TextColor3 = Color3.fromRGB(255, 255, 255)}):Play()
        end))
    ...
    local function selectTab(index)
        ...
        for i, tab in ipairs(tabs) do
            ...
            if tab.label then
                tab.label.TextColor3 = selected and ACCENT or COLOR_TEXT_DIM
            end
        end
        currentTab = tabEntry
    end
    ...
    function window:AddTab(tabData)
        ...
        tabButton.TextColor3 = COLOR_TEXT_DIM
        ...
        tabShimmer.Color = ColorSequence.new({
            ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 255, 255)),
            ColorSequenceKeypoint.new(0.4, Color3.fromRGB(150, 150, 158)),
            ColorSequenceKeypoint.new(0.5, Color3.fromRGB(255, 255, 255)),
            ColorSequenceKeypoint.new(0.6, Color3.fromRGB(150, 150, 158)),
            ColorSequenceKeypoint.new(1, Color3.fromRGB(255, 255, 255)),
        })
        ...
        local function createColumn(position)
            ...
            column.ScrollBarImageColor3 = COLOR_BORDER
        ...
        function tabObject:AddSection(title)
            ...
            group.BackgroundColor3 = COLOR_GROUP
            ...
            groupStroke.Color = COLOR_BORDER
            ...
            headerTitle.TextColor3 = COLOR_TEXT
            ...
            headerArrow.TextColor3 = COLOR_TEXT
        ...
        function tabObject:AddToggle(id, data)
            ...
            checkboxStroke.Color = COLOR_BORDER
            ...
            checkMark.Text = "✓"
            checkMark.TextColor3 = Color3.fromRGB(10, 10, 12)
            ...
            if isMobileNoCooldown then
                ...
                mobileTimerLabel.TextColor3 = COLOR_TEXT_DIM
            ...
            lockedBanner.TextColor3 = COLOR_TEXT_DIM
        ...
        function tabObject:AddSlider(id, data)
            ...
            track.BackgroundColor3 = COLOR_CONTROL
        ...
        function tabObject:AddDropdown(id, data)
            ...
            dropdownFrame.BackgroundColor3 = COLOR_CONTROL
            ...
            dropdownStroke.Color = COLOR_BORDER
            ...
            arrow.TextSize = 19
            arrow.TextColor3 = COLOR_TEXT_DIM
            ...
            local function refreshSelection(value)
                for v, item in pairs(optionViews) do
                    item[1].BackgroundColor3 = v == value and Color3.fromRGB(54, 57, 67) or Color3.fromRGB(28, 28, 33)
                    item[2].Text = (v == value and "✓  " or "    ") .. tostring(v)
                    item[2].TextColor3 = v == value and COLOR_TEXT or COLOR_TEXT_DIM
                end
            end
            ...
            optionsList.BackgroundColor3 = Color3.fromRGB(17, 17, 20)
            optionsList.BackgroundTransparency = GUI_OVERLAY_TRANSPARENCY
            optionsList.BorderSizePixel = 0
            optionsList.ScrollBarThickness = 2
            optionsList.ScrollBarImageColor3 = COLOR_BORDER
            ...
            local function updateOpenState(open)
                ...
                dropdownStroke.Color = dropdown.Opened and Color3.fromRGB(120, 126, 146) or COLOR_BORDER
                openTween:Play()
                arrowTween:Play()
                if count == 0 then
        ...
        function tabObject:AddButton(data)
            ...
            buttonFrame.BackgroundColor3 = COLOR_CONTROL
            ...
            arrowLabel.Text = ">"
            arrowLabel.TextColor3 = COLOR_TEXT_DIM
            ...
            local hoverBg = Color3.fromRGB(44, 44, 51)
            ...
            ConnectClick(buttonFrame, function()
                TweenService:Create(buttonFrame, TweenInfo.new(0.07, Enum.EasingStyle.Quad), {BackgroundColor3 = Color3.fromRGB(50, 50, 55)}):Play()
...
function NexusUI:Notify(options)
    ...
    frame.BackgroundColor3 = COLOR_WINDOW
...
windowSize = IS_MOBILE and UDim2.fromOffset(410, 260) or UDim2.fromOffset(620, 370)
...
-- Settings is desktop-only. On phones it is not created, so it never appears
-- in the horizontally scrollable top tab strip.
...
keybindRow.BackgroundColor3 = COLOR_CONTROL
...
keybindHint.TextColor3 = Color3.fromRGB(130, 130, 138)
...
keybindBadge.BackgroundColor3 = Color3.fromRGB(42, 42, 46)
...
keybindBadgeStroke.Color = Color3.fromRGB(100, 100, 108)
...
keybindBadgeLabel.TextColor3 = Color3.fromRGB(240, 240, 245)
...
function BeginKeyBinding()
    ...
    keybindBadgeLabel.TextColor3 = Color3.fromRGB(210, 210, 215)
    TweenService:Create(keybindBadge, TweenInfo.new(0.15, Enum.EasingStyle.Quad), {
